<!-- Once the first process of password reset is done, the following file displys message saying a mail has been sent for password reset  -->
...
<body>
	...
	<div class="layout1">
		...
		<!-- This basically contains the message part of the webpage, that is displyed. -->
		<div class="login" id="login1">
			<p id='message13'>A mail has been sent to your official email. </br></br> 
							Please check to reset the password.</p>
			<p class='redirect13' id ='belowpart90'><a href='login.php'>Login Page</a></p>
		</div>
