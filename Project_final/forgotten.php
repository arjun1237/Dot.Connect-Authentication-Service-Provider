<!-- This page is for reseting the password. the first phase of the process where email detaisl are taken -->
...
<head>
	...
	<title>Dot.Connect: Password Reset</title>
...
<body>
	...
	<div class="layout1">
		...
		<div class="login">
			...
			<div id ='input76'>
				<form action='resetpass.php' method="POST" onsubmit="return validate(true)">
					<input id='email77' type="text" name="email" placeholder="Email ID [Official]">
					<input id='submit78' type="submit" name="submit" value='  SEND TOKEN'>
				</form>
			</div>

			<i class="fa fa-cog fa-spin" id='spin79'></i>

			<p id="below80"><a href='login.php'>Login Page</a></p>
