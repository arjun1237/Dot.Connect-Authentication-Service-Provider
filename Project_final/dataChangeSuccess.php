<!-- This page is for displaying message saying company details have been updated. -->
...
<head>
	...
	<title>Dot.Connect: Company Detail Update</title>
...
<body>
	...
	<div class="layout1">
		...
		<div class="login">
			<div id='ciara15'>				
				<span id='color15'> &#10004; </span>The update was successful!
			</div>

			<div id='para15'>
				<a href="empsignup.php">Employee Registration</a>
				<a href="login.php">Employee Login</a>
				<a href="company.php">Back to Main Page</a>
			</div>
		</div>
